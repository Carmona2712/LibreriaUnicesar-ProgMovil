<%-- 
    Document   : Editar Autor
    Created on : 14/06/2019, 04:15:44 PM
                        ...
                        <div class="col-lg-10">
                            <div class="card-body">
                                ...
                                <form action="#">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtNombresAutor" value="<% out.print(au.getNombres()); %>"   class="form-control" placeholder="Nombre del Autor">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtApellidosAutor" value="<% out.print(au.getApellidos()); %>"  class="form-control" placeholder="Apellidos Autor">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                    ...
                                    <button type="button" id="btn_Editar_Autor" class="btn btn-md btn-block" style="background:#30A048;color: white;font-weight: bolder;margin-top:1%"><i class="fa fa-pencil-square-o"></i> Editar Autor</button>
                                </form>
                            </div>
                        </div>
