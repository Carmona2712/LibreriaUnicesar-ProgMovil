<%-- 
    ...
    Created on : 12/06/2019, 03:06:56 PM
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtISBN" value="<% out.print(l.getCodigo()); %>" readonly="" class="form-control" placeholder="ISBN">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtNombreLibro" value="<% out.print(l.getNombre()); %>" class="form-control" placeholder="Nombre del Libro">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtFechaLanzamiento" min="0" value="<% out.print(fecha); %>" class="form-control" placeholder="yyyy-mm-dd">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" disabled="5" id="txt_nombreEditorial" class="form-control" value="<% out.print(l.getFkEditorial().getNombre()); %>" placeholder="Nombre Editorial" aria-label="" aria-describedby="basic-addon1">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" disabled="5" id="txt_nombreAutor" class="form-control" value="<% out.print(l.getFkAutor().getApellidos() + ", " + l.getFkAutor().getNombres()); %>" placeholder="Nombre del Autor" aria-label="" aria-describedby="basic-addon1">
                                                    <input class="form-control" hidden="" type="text" value="<% out.print(l.getFkAutor().getId()); %>" id="txtidAutor">
                                                    <div class="input-group-append">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" step="" pattern="[0-9]" id="txtPrecioCompra" class="form-control" value="<% out.print(l.getPrecioCompra()); %>" placeholder="Precio de Compra">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Precio de Venta</label>
                                                <input type="text" id="txtPrecioVenta" pattern="[0-9]" value="<% out.print(l.getPrecioVenta()); %>" class="form-control" placeholder="Precio de Venta">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
