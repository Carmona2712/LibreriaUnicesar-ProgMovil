<%-- 
    Document   : Eliminar Autor
    Created on : 14/06/2019, 06:00:56 PM
...
<%
    ...
    au = ca.findAutor(Integer.parseInt(idAutor));
                        ...
                        <div class="col-lg-10">
                            <div class="card-body">
                                ...
                                <form action="#">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtIDautor"  value="<% out.print(au.getId()); %>" readonly="" class="form-control" placeholder="Apellidos Autor">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Nombres Autor</label>
                                                    <input type="text" id="txtNombresAutor" readonly="" value="<% out.print(au.getNombres()); %>"   class="form-control" placeholder="Nombre del Autor">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtApellidosAutor" readonly="" value="<% out.print(au.getApellidos()); %>"  class="form-control" placeholder="Apellidos Autor">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                    ...
                                    <button type="button" id="btn_Eliminar_Autor" class="btn btn-md btn-block" style="background:#30A048;color: white;font-weight: bolder;margin-top:1%"><i class="fa fa-recycle"></i> Eliminar Autor</button>
                                </form>
                            </div>
                        </div>
