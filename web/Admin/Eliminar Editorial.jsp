<%-- 
    Document   : Eliminar Editorial
    Created on : 16/06/2019, 10:45:37 PM
                        ...
                        <div class="col-lg-10">
                            <div class="card-body">
                                <div class="card-header" style="background-color: #30A048;">
                                    <h4 class="m-b-0 text-white" style="font-weight: bold">Eliminar Editorial</h4>
                                </div>
                                <form action="#">
                                    <div class="form-body">
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="txtNombreEditorial" disabled="" value="<% out.print(e.getNombre()); %>"  class="form-control" placeholder="Nombre de la Editorial">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <!--/span-->
                                    ...
                                    <button type="button" id="btn_Eliminar_Editorial" class="btn btn-md btn-block" style="background:#30A048;color: white;font-weight: bolder;margin-top:1%"><i class="fa fa-recycle"></i> Eliminar Editorial</button>
                                </form>
                            </div>
                        </div>
