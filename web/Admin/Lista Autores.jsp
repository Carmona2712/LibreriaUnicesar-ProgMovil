                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <table id="tabla-Autores" class="table">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="color: black;font-weight: bolder;text-align: center;vertical-align: middle"><% out.print(au.getId()); %></td>
                                                <td style="color: black;font-weight: bolder;text-align: center;vertical-align: middle"><% out.print(au.getNombres()); %></td>
                                                <td style="color: black;font-weight: bolder;text-align: center;vertical-align: middle"><% out.print(au.getApellidos()); %></td>
                                                <td style="color: black;font-weight: bolder;text-align: center;vertical-align: middle"><a href="Editar Autor.jsp?id=<% out.print(au.getId()); %>"><button class="btnEditarAutor btn btn-warning">Editar</button></a></td>
                                                <td style="color: black;font-weight: bolder;text-align: center;vertical-align: middle"><a href="Eliminar Autor.jsp?id=<% out.print(au.getId()); %>"><button class="btnEliminarAutor btn btn-danger">Eliminar</button></a></td>
                                            </tr>
                                            <% } %>
                                        </tbody>
                                    </table>
