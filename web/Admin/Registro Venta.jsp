                        ...
                        <div class="col-lg-12">
                            <div class="card-body">
                                ...
                                <form action="#">
                                    ...
                                    <!-- /Row -->
                                    <button type="button" id="btn_Registrar_Venta" class="btn btn-md btn-block" style="background:#30A048;color: white;font-weight: bolder;margin-top:4%;font-size: 18px"><i class="fa fa-save"></i> Registrar Transacción de Venta</button>
                                </form>
                            </div>
                        </div>
